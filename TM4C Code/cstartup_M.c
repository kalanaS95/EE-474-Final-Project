...
extern void Timer_Handler_A( void ); //Timer 0A ISR
//extern void portD_Handler( void );
//extern void TouchScreen_Handler( void ); //Timer 0A ISR
//extern void GPIO_Handler_F( void ); //GPIO POrt F ISR
//extern void ADC_Hadnler_SS3(void); //ADC0 SS3 ISR
...
const intvec_elem __vector_table[] =
{
  ...
  PendSV_Handler,
  SysTick_Handler, //15
  0,//TouchScreen_Handler, //since we need to check if we have data in Port A
  0,
  0,
  0,//portD_Handler,
  0,//TouchScreen_Handler, //20  since we need to check if we have data in Port E
  0,
  0,
  0,
  0,
  ...
  0,
  0,
  0,//ADC_Hadnler_SS3, //ADC ss3 ISR
  0,
  Timer_Handler_A, //--35 (starting from ) // Timer 0A ISR
  0,
  0,
  0,
  0,
  ...
  0,
  0,
  0//GPIO_Handler_F //GPIO port F ISR
